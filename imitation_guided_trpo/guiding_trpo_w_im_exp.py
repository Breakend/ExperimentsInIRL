...
from guiding_trpo_trainer import Trainer
...
def run_experiment(expert_rollout_pickle_path, trained_policy_pickle_path, env, cost_trainer_type, iterations=30, num_frames=1, traj_len=200, config={}):
    ...
    with tf.Session() as sess:
        ...
        for iter_step in range(0, iterations):
            ...
            true_reward, actual_reward = trainer.step(dump_datapoints=dump_data, config=config, expert_horizon=traj_len, number_of_sample_trajectories=number_of_sample_trajectories)
