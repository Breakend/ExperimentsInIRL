...
class Trainer(object):
    ...
    def __init__(self, sess, env, cost_approximator, cost_trainer, novice_policies, novice_policy_optimizer, num_frames=4, concat_timesteps=True):
        """
        ...
        self.iteration = 0
        self.novice_policies = novice_policies
