...
from ppaquette_gym_doom.wrappers.action_space import *
from ppaquette_gym_doom.wrappers.observation_space import *
from ppaquette_gym_doom.wrappers.multi_discrete import *
import traceback
import logging
...
def convert_gym_space(space):
    ...
    elif isinstance(space, DiscreteToMultiDiscrete):
        return Discrete(n=space.n)
...
class DoomEnv(Env, Serializable):
    def __init__(self, env_name, record_video=True, video_schedule=None, log_dir=None, record_log=True,
        ...
        res_wrapper = SetResolution('160x120')
        env = wrapper(res_wrapper(env))
